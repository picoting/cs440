    ...
    extends Agent
{
	...
	public ScriptedAgent(int playerNum, String[] args)
	{
        ...
        this.script = new LinkedList<Action>();
    ...
    public Queue<Action> getScript() { return this.script; }
                                            ...
                                            HistoryView history)
	{
        ...
        // ummm idk how to call the resource type lol
        ...
        {
            this.getScript().add(Action.createPrimitiveMove(this.getMyUnitId(), Direction.EAST));
        }
                                           ...
                                           HistoryView history)
    {
        ...
        {
            actions.put(this.getMyUnitId(), this.getScript().poll());
        } else // if the queue is empty....assume we're next to the enemy and attack
        {
